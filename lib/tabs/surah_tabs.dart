...
class SurahTab extends StatelessWidget {
  ...
  Future<List<Surah>> _getSurahList() async {
    String data = await rootBundle.loadString('assets/models/list_surah.json');
        ...
        builder: ((context, snapshot) {
          ...
          return ListView.separated(
              ...
              separatorBuilder: (context, index) => Divider(
                    color: const Color(0xFF7B80AD).withOpacity(.5),
                  ),
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Stack(
                children: [
                  SvgPicture.asset('assets/icons/no_surah_icon.svg'),
                  SizedBox(
                    height: 36,
                    width: 36,
                    child: Center(
